                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    if (snapshot.exists()) {
                        ...
                        for (bookSnapshot in snapshot.children) {
                           ...
                           if (bookSnapshot.child("Status").value.toString() == "Available to Sell" ||bookSnapshot.child("Status").value.toString() == "Available to Sell & Exchange" || bookSnapshot.child("Status").value.toString() == "Already sold"){
                ...
                FirebaseDatabase.getInstance()
                    ...
                    .addListenerForSingleValueEvent(object : ValueEventListener {
                        override fun onDataChange( dataSnapshot: DataSnapshot) {
                            ...
                            val reviewView = Intent(this@Ready_to_Sell_Book_List_for_me, Viewing_reviews::class.java)
